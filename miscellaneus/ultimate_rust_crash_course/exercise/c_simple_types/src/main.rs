...
fn main() {
    ...
    // 2. We want to    the `print_array` function to print coords...but coords isn't an array!
    ...
    //  array indexing.  Done correctly, `cargo run` will produce the additional output
    // "Ding, you found 13!"
    //
    ding(series[6]);
    ...
    // - Bring all the functions into scope using   statements. Remember, the name of the library
    //   is defined in Cargo.toml.  You'll need to know that to      it.
    //
