...
/// # PUMPKIN!!
/// ## ![Pumpkin_img](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
impl Pumpkin {
    /// If you smash pumpikin, it will be gone. Then it can't be used for pie.
    pub fn smash(self) {}
}
